...
int main()
{
    ...
    XSelectInput(display, window, ExposureMask | KeyPressMask | ButtonPressMask | PointerMotionHintMask);
    ...
    while(1) {
        ...
        if(event.type == KeyPress){
            handle_keypress(event, display, screen, &current_color, &current_shape,
            &shape_count, window);
        }
